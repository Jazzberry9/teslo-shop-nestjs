...
// agregado para anadir users al seed
interface SeedUser {
    email: string;
    fullName: string;
    password: string;
...
interface SeedData {
    users: SeedUser[]; // agregado por lo de user too
    products: SeedProduct[];
}


export const initialData: SeedData = {
    // users agregados para el seed
    users: [
        {
            email: 'prueba1@google.com',
            fullName: 'Prueba juan',
            password: 'Abc123',
            roles: ['admin']
        },
        {
            email: 'prueba2@google.com',
            fullName: 'Prueba dous',
            password: 'Abc123',
            roles: ['user', 'super']
        },
    ],
